...
public:
    ...
    void algoritmoDeKruskal(){
        ...
        for(int i = 0; i < size_arvore; i++){
            char primeiroV = 'A' + arvore[i].obterPrimeiroVertice();
            char segundoV = 'A' + arvore[i].obterSegundoVertice();
...
int main(int argc, char *argv[]){
    ...
    for( int i = 0; i < k; i++){
    printf("%d %d %d\n", z.arestasGrafo[i].obterPrimeiroVertice(), z.arestasGrafo[i].obterSegundoVertice(),  z.arestasGrafo[i].obterValorPeso());
